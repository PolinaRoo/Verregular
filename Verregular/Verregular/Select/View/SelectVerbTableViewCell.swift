...
final class SelectVerbTableViewCell: UITableViewCell {
    ...
    private lazy var stackView: UIStackView = {
        ...
        // горизонтальный или вертикальный стек
        view.axis = .horizontal
        // каким образом выравниваются элементы в стеке
        view.distribution = .fillEqually
        // вертикальное выравнивание в горизонтальным стеке
    ...
    func setupConstraints() {
        ...
        translationLabel.snp.makeConstraints { make in
            ...
            make.top.equalTo(infinitiveView.snp.bottom).offset(-25)
        }
